...
internal static partial class Interop
{
    internal static partial class Ssl
    {
        ...
        internal delegate int SslCtxSetClientHelloCallback(IntPtr ssl, ref int al, IntPtr arg);
        ...
        [DllImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_SslCtxSetClientHelloCb")]
        internal static extern void SslCtxSetClientHelloCb(SafeSslContextHandle ctx, SslCtxSetClientHelloCallback callback, IntPtr arg);
